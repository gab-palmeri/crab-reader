use druid::{Widget, UnitPoint, widget::{Flex, Either, Scroll, Label, LineBreaking, TextBox}, LensExt, WidgetExt};

use crate::{CrabReaderState, components::{buttons::rbtn::RoundedButton, chapter_selector::ChapterSelector}, ReadingState, traits::{gui::GUILibrary, note::NoteManagement}};
